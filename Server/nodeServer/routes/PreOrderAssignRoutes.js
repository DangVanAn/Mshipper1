...
//     PreOrderAssign.find({}, function (err, preorders) {
//         if (err)
//             return console.error(err);
//         else {
//             listPreOrders = [];
...
//         }
//         else {
//             var index = checkExistPreOrderReport(data);
//             if(index !== -1){
//                 preOrderReport[index]._ton += data._ton;
//             }
//             else {
//                 preOrderReport.push(data);
//             }
...
//     }
//
//     console.log('createPreOrderReport', preOrderReport.length);
//     return true;
// }
//
...
// }
//
// function checkExistPreOrderReport(data) {
//
...
//         }
//
//         // if(hashmap.get(req.body[i]._id_product_group) !== '_id_product_group')
//         // {
//         //     if(listProductGroupNotInData.indexOf(req.body[i]._id_product_group) === -1)
//         //     {
//         //         listProductGroupNotInData.push(req.body[i]._id_product_group);
//         //     }
//         // }
//         //
//         // if(hashmap.get(req.body[i]._id_product) !== '_id_product')
//         // {
//         //     if(listProductNotInData.indexOf(req.body[i]._id_product) === -1)
//         //     {
//         //         listProductNotInData.push(req.body[i]._id_product);
//         //     }
//         // }
//
...
//     }
//
//     // for(var i = 0; i < listProductGroupNotInData.length; i++)
//     // {
//     //     console.log(i, 'productGroup', listProductGroupNotInData[i], 'notInData');
//     // }
//     //
//     // for(var i = 0; i < listProductNotInData.length; i++)
//     // {
//     //     console.log(i, 'product', listProductNotInData[i], 'notInData');
//     // }
//
...
//
//     PreOrderAssign.insertMany(listNewOrders, function (err, docs) {
//         if (err) {
